                        ...
                        <Card.Body>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className='d-flex justify-content-between primary pb-2'>
                                    <button className='border-0 primary px-3 py-2' disabled style={{ background: '#000', minWidth: '120px' }}>Amount</button>
                                    <input className='w-100 ps-1' type="text" name="" id="" />
                                </div>
                                <div className='d-flex justify-content-between primary pb-2'>
                                    <button className='border-0 primary px-3 py-2' disabled style={{ background: '#000', minWidth: '120px' }}>Select Pool</button>
                                ...
                                <input className='primary w-100 border-0 py-2 my-2 fs-lg-4' style={{ background: '#165CA9' }} type="submit" value="Mine in this pool" />
                            </form>
                        </Card.Body>
                    </Card>
                </div>
