            ...
            <div className='row g-5 align-items-center'>
                <div className='col-md-6'>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div>
                            <Button sx={{ borderRadius: '10px', background: '#FFC000', color: '#000', marginRight: '10px', fontWeight: '700', '&:hover': { background: '#FFC000' } }} variant='contained'>Lite Paper <RiDownload2Fill size={20} /></Button>
