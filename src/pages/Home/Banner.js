            ...
            <div className='container pb-4' >
                <div className='row align-items-center'>
                    <div className='col-lg-6 col-sm-12 text-white'>
                        <p className='primary fs-4 mt-5'>WHERE CRYPTO MEETS COMMODITIES</p>
                        <p className='primary fs-1 fw-bold'>DECENTRALIZED  ECO-FRIENDLY<br />  BLOCKCHAIN <br /> TECHNOLOGY</p>
